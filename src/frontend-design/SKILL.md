...
description: > 
  ...
  web components, pages, artifacts, posters, or applications (examples include 
...
application, or interface to build. 
They may include context about 
...
- **Motion**: Use animations for effects and micro-interactions. Prioritize CSS-only solutions for HTML. Use Motion library for React only if it is already installed and available in the project. Focus on high-impact moments: one well-orchestrated page load with staggered reveals (animation-delay) creates more delight than scattered micro-interactions. Use scroll-triggering and hover states that surprise.
